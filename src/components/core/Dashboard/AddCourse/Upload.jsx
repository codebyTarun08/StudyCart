...
export default function Upload({
 ...
 const {
  ...
  if (editData && !selectedFile) {
    // set the string value just to satisfy validation (not used on submit)
    setValue(name, editData);
  }
  }, [register, name, editData, selectedFile, setValue]);
  useEffect(() => {
        ...
        {previewSource ? (
          ...
          >
            ...
            <p className="mt-2 max-w-[200px] text-center text-sm text-richblack-200">
              Drag and drop a {video ? "video" : "thumbnail"}, or click to{" "}
