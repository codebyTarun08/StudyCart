...
export default function Instructor() {
    ...
    useEffect(() => {
      ;(async () => {
        ...
        //console.log("Response..",instructorApiData)
    ...
    return (
      ...
      {loading ? (
        <div className="flex justify-center items-center w-full h-64 md:h-screen spinner"></div>
      ) : courses.length > 0 ? (
        <div>
        <div className="my-4 flex flex-col lg:flex-row h-auto lg:h-[450px] space-y-4 lg:space-y-0 lg:space-x-4">
          ...
          <div className="flex-1 min-h-[250px] rounded-md bg-richblack-800 p-6 flex flex-col justify-center items-center">
          ...
          {/* Total Statistics */}
          <div className="flex min-w-[200px] flex-col rounded-md bg-richblack-800 p-6">
        ...
        <div className="rounded-md bg-richblack-800 p-6">
          ...
          {courses.slice(0, 3).map((course) => (
            ...
            <img
              ...
              className="h-[180px] md:h-[201px] w-full rounded-md object-cover"
            />
